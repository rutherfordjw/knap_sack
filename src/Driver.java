...
public class Driver {
	 ...
	 */
	public Driver(UserInterface ui, Population population, Crossover crossover, Mutation mutation, double mutationRate) {
		// Initialize fields
		pop = population;
		cross = crossover;
		mute = mutation;
